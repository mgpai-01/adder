...
//
// Managers do get the Production Grid, so anything money-related on that
// screen has to be gated on the role itself — see showSupplyCost, which is
// what keeps supply prices off a manager's copy of it.
