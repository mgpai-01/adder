...
function Payroll({
  ...
  onSelectEmployee: (employeeId: string) => void;
  // Writes imported hours onto an entry / remembers a person's AMG code.
  ...
  return (
    <div className="grid gap-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {/* Upload the AMG Time "Timecard" report (Excel/CSV) to pull each
              person's daily hours into their entries. */}
          <label
            className={classNames(
          ...
          >
            ...
            {hoursImportBusy ? "Reading…" : "Import Hours"}
            <input
              type="file"
              accept=".xlsx,.xls,.csv"
              className="hidden"
...
function Settings({
  ...
  return (
    <div className="grid gap-5">
      ...
      {activeTab === "pallets" && <PalletAdmin palletTypes={palletTypes} entries={entries} onCreate={onCreatePallet} onUpdate={onUpdatePallet} onDelete={onDeletePallet} />}
